{
  ...
  outputs = { self, nixpkgs, nixpkgs-unstable, ... }@inputs: {
    nixosConfigurations = {
      ...
      "higashi" = nixpkgs.lib.nixosSystem {
        system = "x86_64-linux";
        ...
        modules = [
          ...
          # ADDED FROM ABOVE SHARED REDDIT LINK. ORIGINAL FILE ONLY CONTAINED ./configuration.nix
          ...
          in
              ...
              environment.systemPackages = with pkgs; [ unstable.haskellPackages.hello ];
              }
           )
